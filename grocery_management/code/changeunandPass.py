...
# Window Icon Photo
# icon = PhotoImage(file='C:\\Users\\admin\\Desktop\\grocery management\\code\\header5.jpg')
...
# ===== Email icon =========
# email_icon = Image.open('code\\image\\email-icon.png')
...
# ===== Left Side Picture ============
side_image = Image.open('image\\vector.png')
...
confirmPassword_icon = Image.open('image\\pass-icon.png')
